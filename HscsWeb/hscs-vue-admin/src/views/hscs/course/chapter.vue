    ...
    <el-form :model="video" label-width="120px">
        ...
        <el-form-item label="上传视频">
            <el-upload
                ...
                :file-list="fileList"
                :action="BASE_API+'/videoupload/video/uploadVideo'"
                :limit="3"
                class="upload-demo">
...
<script>
import chapter from '@/api/hscs/chapter'
import video from '@/api/hscs/video'
    ...
    data() {
        return {
            ...
            video: {
                ...
                sort: 0,
                isFree: false,
                videoSourceId: '', //上传视频后的id
                videoOriginalName: '' //视频上传的名称
            },
