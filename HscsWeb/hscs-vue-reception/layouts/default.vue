  ...
  <div class="in-wrap">
    ...
    <header id="header">
      <section class="container">
        <h1 id="logo">
          <a href="#" title="家校沟通系统">
            <img src="~/assets/img/logo.png" width="100%" alt="家校沟通系统">
          </a>
        </h1>
        <div class="h-r-nsl">
          <ul class="nav">
            ...
            <router-link to="/wechat" tag="li" active-class="current">
              <a>沟通</a>
            </router-link>
          </ul>
          <!-- / nav -->
      ...
      <section class="container">
        <div class>
          ...
          <ul class="of flink-list">
            <li>
              <a href="http://www.baidu.com/" title="家校通" target="_blank">家校通</a>
            </li>
          </ul>
          <div class="clear"></div>
        </div>
          ...
          <section class="fl col-7">
            <section class="mr20">
              <section class="b-f-link">
                ...
                <span>服务热线：18407531537</span>
                <span>Email：2672885962@qq.com</span>
              </section>
    ...
    methods: {
      ...
      wxLogin() {
        ...
        loginApi.getLoginUserInfo()
          .then(response => {
            // console.log("登录返回用户信息：",response.data.data.userInfo)
